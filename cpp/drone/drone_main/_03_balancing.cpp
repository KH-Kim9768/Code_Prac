...
void calc(
    ...
    gyro_angle_t& gyro_angle) {
        ...
        // 증폭값 : 1, 힘이 더 필요하면 1보다 크게, 힘이 너무 센 경우엔 1보다 작게
...
void distribute(
    ...
    throttle_t& throttle, 
    balancing_force_t& balancing_force) {
        motor_speed.a = throttle.value + balancing_force.yaw + balancing_force.roll + balancing_force.pitch;
        motor_speed.b = throttle.value - balancing_force.yaw - balancing_force.roll + balancing_force.pitch;
        motor_speed.c = throttle.value + balancing_force.yaw - balancing_force.roll - balancing_force.pitch;
        motor_speed.d = throttle.value - balancing_force.yaw + balancing_force.roll - balancing_force.pitch;
...
void add(balancing_force_t& balancing_force, gyro_rate_t& gyro_rate) {
...
void add(
    ...
    dt_t& dt) {
        ...
        res_force_yaw += 1 * angle_error_yaw * dt.t_period;
